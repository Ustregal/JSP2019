...
pytanie = input("reczne wprowadzanie sciezki? (y/n): ")

if pytanie=="n":
    sciezka = "P:\Materiały naukowe\dziewiąty semestr - materiały\Python\Ćwiczenia\lista 10\kursy.xml"
elif pytanie=="y":
    sciezka = input("podaj pelna sciezke do pliku: ")
...
#print(nazwawaluty[2].firstChild.data)
#print(nazwawaluty[2].childNodes[0].data)
